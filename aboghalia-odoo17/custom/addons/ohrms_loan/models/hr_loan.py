...
class HrLoan(models.Model):
    ...
    date = fields.Date(string="Date", default=fields.Date.today(), help="Date of the loan request")
    ...
    is_readonly = fields.Boolean(
        ...
        help="True when loan is fully paid: total_amount equals "
             "total_paid_amount, balance_amount is 0, and total_amount > 0.")
    ...
    @api.depends('total_amount', 'total_paid_amount', 'balance_amount')
    def _compute_is_readonly(self):
        for loan in self:
            # New/empty loans are 0/0/0 — must stay editable.
            loan.is_readonly = (
                loan.total_amount > 0
                and loan.total_amount == loan.total_paid_amount
    ...
    def create(self, values):
        ...
        # else:
        values['name'] = (
            self.env['ir.sequence'].next_by_code('hr.loan.seq') or _('New')
        )
