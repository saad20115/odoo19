...
class HrEmployeeMonthlySummary(models.Model):
    ...
    late_hours_manually_set = fields.Boolean(
        string='Late Hours Manually Set',
        default=False,
        help='When set, late hours were manually adjusted and should not be overwritten by automatic calculations',
    )
