...
class HrAttendance(models.Model):
    ...
    def _check_location_range(self):
        for attendance in self:
            ...
            if employee.use_specific_locations and employee.location_range_ids and not employee.free_attendance:
                within_range = False
                closest_range = None
    ...
    def check_location_range_for_notification(self, employee, in_latitude, in_longitude):
        user_location = (in_latitude, in_longitude)
        # Check if employee has specific location ranges assigned and the feature is enabled
        if employee.use_specific_locations and employee.location_range_ids and not employee.free_attendance:
            within_range = False
            closest_range = None
