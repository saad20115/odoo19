...
* متوافق 100% مع أودو 17 (كومينتي وانتربرايس) وجاهز للبيع على متجر أودو.
    ...
    'data': [
        ...
        'views/unified_contract_invoice_views.xml',
        'views/unified_contract_team_views.xml',
        'views/unified_contract_permission_profile_views.xml',
        'views/unified_contract_work_order_map_views.xml',
        'views/unified_contract_analytics_dashboard_views.xml',
        'reports/completion_certificate_report.xml',
        'views/menu_views.xml',
    ],
    'assets': {
        'web.assets_backend': [
            'ao_unified_contract_project/static/src/js/work_order_map_backend.js',
            'ao_unified_contract_project/static/src/xml/work_order_map_backend.xml',
            'ao_unified_contract_project/static/src/js/analytics_dashboard.js',
            'ao_unified_contract_project/static/src/xml/analytics_dashboard.xml',
        ],
    },
