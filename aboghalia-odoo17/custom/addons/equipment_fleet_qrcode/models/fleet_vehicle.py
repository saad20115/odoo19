...
class FleetVehicle(models.Model):
    ...
    def create(self, vals):
        ...
        if not prefix:
            raise UserError(_('Set A Fleet Prefix In General Settings'))
        prefix = str(prefix)
    ...
    def generate_sequence(self):
        ...
        if not prefix:
            raise UserError(
                _('Set A Fleet Prefix In General Settings'))
        prefix = str(prefix)
    ...
    def generate_qr(self):
        ...
        if qrcode and base64:
            ...
            return self.env.ref(
                'equipment_fleet_qrcode.print_qr').report_action(self, data={
    ...
    def get_partner_by_qr(self, **args):
        ...
        return self.env['fleet.vehicle'].search([('sequence', '=', self.id), ],
                                              limit=1).id
