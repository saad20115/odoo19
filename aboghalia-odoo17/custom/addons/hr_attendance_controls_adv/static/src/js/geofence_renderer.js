odoo.define('hr_attendance_controls_adv.GeofenceRenderer', function (require) {
    'use strict';
    ...
    var GeofenceRenderer = BasicRenderer.extend({        
        ...
        xmlDependencies: ['/hr_attendance_controls_adv/static/src/xml/geofence_template.xml'],
