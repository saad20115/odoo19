...
class GeneralLedger extends Component {
    ...
    SearchBarAccounts(ev) {
        ...
        if(this.state.journals){
            this.state.searched_journal_list = this.state.journals.filter(function (el) {
                return el.name.includes(ev.target.value);
              });
             console.log(this.state.searched_journal_list) 
        }
...
registry.category("actions").add("gen_l", GeneralLedger);
