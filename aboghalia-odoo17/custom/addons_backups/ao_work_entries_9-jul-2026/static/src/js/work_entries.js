...
class AttendanceGridComponent extends Component {
  ...
  getSummaryValue(employeeId, fieldName) {
    const isIntegerField = fieldName === "total_absence_days" || fieldName === "remaining_leave_days";
  ...
  formatSummaryValue(value, fieldName) {
    if (value === null || value === undefined) {
      return fieldName === "total_absence_days" || fieldName === "remaining_leave_days" ? "0" : "0.0";
    }

    if (fieldName === "total_absence_days" || fieldName === "remaining_leave_days") {
...
class SummaryFieldEditDialog extends Component {
  ...
  onSave() {
    if (this.validateValue()) {
      const isIntegerField =
        ...
        this.props.fieldName === "remaining_leave_days";
  ...
  getInputStep() {
    return this.props.fieldName === "total_absence_days" ||
      this.props.fieldName === "remaining_leave_days"
      ? "1"
      : "0.1";
  }
