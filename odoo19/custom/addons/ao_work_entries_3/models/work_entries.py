...
class HrEmployeeAttendanceGrid(models.Model):
    ...
    def _process_employee_month_data(self, employee_id, year, month, days_list, 
        ...
        for day in days_list:
            ...
            # Check for attendance records (priority display if exists)
            ...
            if attendance_record:
                ...
                # Add indicator if employee checked in during their leave or public holiday
            ...
            # If no attendance but has public holiday, show as holiday
            if is_public_holiday:
            ...
            # If no attendance but has leave, show as leave
            if leave_data:
    ...
    def create_attendance_record(self, employee_id, date, check_in, check_out=None, notes=None, 
        ...
        try:
            ...
            _logger.info(f"Creating attendance record with check_in: {check_in_naive} (UTC) for employee {employee_id} on date {date}")
