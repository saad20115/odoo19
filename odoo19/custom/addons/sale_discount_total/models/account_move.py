...
class AccountInvoice(models.Model):
        ...
        for inv in self:
            ...
            if inv.discount_type == 'percent':
                ...
                for line in inv.invoice_line_ids:
                    ...
                    inv.amount_discount = discount_totals + line.discount_value_f
                    line._compute_totals()
                    line.calculate_discount_value_f()
            else:
                total = 0.0
                for line in inv.invoice_line_ids:
    ...
    def _discount_total_update_amount(self):
        discount_totals_amounts = 0
        for line in self.invoice_line_ids:
            discount_totals_amounts = discount_totals_amounts + line.discount_value_f
        self.amount_discount = discount_totals_amounts
