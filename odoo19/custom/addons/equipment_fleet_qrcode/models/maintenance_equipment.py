...
class MaintenanceEquipment(models.Model):
    """Extends the maintenance equipment model to include QR code functionality."""
    ...
    def create(self, vals):
        ...
        prefix = str(prefix)
        seq = prefix + self.env['ir.sequence'].next_by_code('maintenance.equipment') or '/'
        vals['sequence'] = seq
        qr = qrcode.QRCode(
            version=1,
    ...
    def generate_qr(self):
        ...
        if qrcode and base64:
            ...
            return self.env.ref(
                'equipment_fleet_qrcode.print_qr1').report_action(self, data={
