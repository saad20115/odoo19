odoo.define('hr_attendance_controls_adv.GeofenceView', function (require) {
    'use strict';
    ...
    var GeofenceModel = require('hr_attendance_controls_adv.GeofenceModel');
    var GeofenceRenderer = require('hr_attendance_controls_adv.GeofenceRenderer');
    var GeofenceController = require('hr_attendance_controls_adv.GeofenceController');
