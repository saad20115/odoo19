...
class HrLeaveType(models.Model):
    ...
    full_admin_ids = fields.Many2many(
        'res.users',
        'hr_leave_type_full_admin_rel',
        'leave_type_id',
        'user_id',
        string='Full Approval Admins',
        help="These users can approve the leave alone using a special button."
    )
